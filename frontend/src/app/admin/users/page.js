                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4">
                                        <div className="flex-1">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input type="text" id="table-search" className="w-full h-11 pl-10 pr-4 text-sm text-gray-600 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#205781]/20 focus:border-[#205781] transition-all duration-200" placeholder="Search by username" value={searchData} onChange={search} />
                                            </div>
                                        </div>
